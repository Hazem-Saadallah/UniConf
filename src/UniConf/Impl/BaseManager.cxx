...
bool UniConf::Impl::BaseManager::is_initalized() const { return m_Initalized; }
std::string UniConf::Impl::BaseManager::get_config_path() const { return m_ConfigPath; }
...
void UniConf::Impl::BaseManager::refresh() { load(m_ConfigPath); }
